...
export async function render() {
  const filters = { exclude_non_project: '', project_id: '', value_source: '', from: '', to: '' };
  const root = el('div');
  ...
  async function loadAll() {
    ...
    clear(chartBox).append(
      ...
      el('div', { class: 'card' },
        el('h2', { text: 'ที่มาของค่าและความเชื่อถือ' }),
